...
```
### Windows
Download the submod [here](https://github.com/ChrisLad1/ExtraDialogue/releases/latest/ED.rpy) and put the file into the "game" directory. [Here](https://imgur.com/UJRsGEw) is an example
